...
// 				Config: NotifierConfig(json.RawMessage(`{"webhook_url": "https://hooks.slack.com/test"}`)),
// 			},
// 			want: &SlackConfig{
...
// 			notifier: &Notifier{
// 				Type:   NotifierTypeSlack,
// 				Config: NotifierConfig(json.RawMessage(`invalid json`)),
// 			},
// 			want:    nil,
// 			wantErr: true,
// 		},
...
// 			notifier: &Notifier{
// 				Type: NotifierTypeEmail,
// 				Config: NotifierConfig(json.RawMessage(`{
